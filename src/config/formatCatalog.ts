    ...
    fields: [
      ...
      // Inspección extintores
      {
        ...
        subFields: [
          ...
          { name: "ext_a_2lb", label: "2 LB", type: "number", required: false },
          { name: "ext_a_5lb", label: "5 LB", type: "number", required: false },
          { name: "ext_a_10lb", label: "10 LB", type: "number", required: false },
          { name: "ext_a_20lb", label: "20 LB", type: "number", required: false },
          { name: "ext_a_30lb", label: "30 LB", type: "number", required: false },

          { name: "header_tipo_b", label: "Tipo B", type: "header", required: false },
          { name: "ext_b_5lb", label: "5 LB", type: "number", required: false },
          { name: "ext_b_10lb", label: "10 LB", type: "number", required: false },
          { name: "ext_b_15lb", label: "15 LB", type: "number", required: false },
          { name: "ext_b_20lb", label: "20 LB", type: "number", required: false },
          { name: "ext_b_50lb", label: "50 LB", type: "number", required: false },

          { name: "header_multi", label: "Multipropósito", type: "header", required: false },
          { name: "ext_multi_5lb", label: "5 LB", type: "number", required: false },
          { name: "ext_multi_10lb", label: "10 LB", type: "number", required: false },
          { name: "ext_multi_15lb", label: "15 LB", type: "number", required: false },
          { name: "ext_multi_20lb", label: "20 LB", type: "number", required: false },
          { name: "ext_multi_30lb", label: "30 LB", type: "number", required: false },
